...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\Column]
    #[Assert\NotBlank(message: "Vous avez besoin d'un mot de passe")]
    ...
    public function setIdEmail(Email $idEmail): static
    {
